...
//       priority: 2,
//       folder: 'inbox',
//       attachments: [{ name: 'job_desc.pdf', id: 'f2', size: '500KB', type: 'application/pdf' }],
//     },
...
//       id: '369',
//       subject: 'Go to sleep',
//       body: 'Just checking on u mate, u looked tired today, have u been sleeping good lately? ',
//       sender: { name: 'Omar', email: 'omar@student.alex.edu' },
//       to: ['mohamedAbbas@alex.edu.eg'],
//       date: new Date(new Date().setDate(new Date().getDate() - 1)),
//       isRead: false,
//       priority: 4, // High
//       folder: 'project',
...
//   getEmails(): Email[] {
//     return this.mockEmails as Email[];
//   }
...
//   summarizeEmailAI(email: Email) {}

//   // This is used for the download button for an attachment
//   getFileContentFromEmail(email: Email, fileId: string): Blob {
//     const fakeContent = `This is a mock file for ${fileId}...`;

//     // I wrapped it in a "Binary Large Object" (Blob) to pretend it's a file
//     const blob = new Blob([fakeContent], { type: 'text/plain' });
//     return blob;
//   }

//   editFolderName(folderId: string, newName: string) {}
